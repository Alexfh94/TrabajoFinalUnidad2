...
public class Actividad2 extends AppCompatActivity {
    ...
    private final String TAG = " TEST Actividad2";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i(TAG, "Entrando en Actividad2.onCreate");

        // Recuperar historial de mensajes y horas desde MainActivity
        ...
        if (historial != null && horas != null) {
            ...
            Log.i(TAG, "Historial recibido en Actividad2: " + historialMensajes);

            for (int i = 0; i < historialMensajes.size(); i++) {
                boolean esEnviado = (i % 2 != 0); // En Actividad2, los mensajes impares son los enviados
    ...
    private void addMessage(String mensaje, boolean enviado) {
        Log.i(TAG, "Añadiendo mensaje en Actividad2: " + mensaje + ", enviado: " + enviado);
    ...
    public void onClick(View view) {
        Log.i(TAG, "Boton pulsado en Actividad2");

        String mensaje = textMsj.getText().toString();
        if (!mensaje.isEmpty()) {
            addMessage(mensaje, true);

            Log.i(TAG, "Enviando mensaje desde Actividad2: " + mensaje);
            Log.i(TAG, "Historial antes de cambiar de actividad: " + historialMensajes + historialHoras);

            // Enviar el historial de mensajes y horas a MainActivity
            ...
            launchMainActivity.putStringArrayListExtra("horas", historialHoras);
            startActivity(launchMainActivity);

            Log.i(TAG, "Cambio de actividad: Actividad2 -> MainActivity");
        }
    }
}
